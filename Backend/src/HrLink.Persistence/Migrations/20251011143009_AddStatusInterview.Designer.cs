...
namespace HrLink.Persistence.Migrations
{
    ...
    [Migration("20251011143009_AddStatusInterview")]
    partial class AddStatusInterview
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HrLink.Domain.Entities.Status", b =>
                {
                    b.Property<byte>("Id")
                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("HrLink.Domain.Entities.Interview", b =>
                {
                    ...
                    b.HasOne("HrLink.Domain.Entities.Status", "Status")
                        .WithMany("Interviews")
